...
fill_6 = 255     # fill_5 variable colors the text "Screebshot"
...
def draw():
    ...
    fill(fill_6, 255, fill_6)
    text("Screen", width//2-550, height//2+240) #Vitalii Pshenychniak
...
def mouseClicked():
    global hair_selected, torso_selected, legs_selected, footwear_selected, dresses_selected, screebshot_selected
    if mouseX >= 1193 and mouseX <= 1268 and mouseY >= 7 and mouseY <= 47:
        exit()
    #if mouseX >= 945 and mouseX <= 80  and mouseY >= 650 and mouseY <= 40:
        #exit()  
    ...
    if mouseX >= width//2-550 and mouseX <= width//2-550 + 110 and mouseY >= height//2-130 - 30 and mouseY <= height//2-130 + 3:
        ...
        wlosy_czarne_2.x = 1500
        wlosy_czarne_2.y = 200
        bluzka_niebieska.x = 350
        bluzka_niebieska.y = 75
        bluzka_rozowa.x = 475
        bluzka_rozowa.y = 75
        bluzka_zielona.x = 605
        bluzka_zielona.y = 75
        koszulka_czarna.x = 350
        koszulka_czarna.y = 310
        spodnica_brazowa.x = 1500
        spodnica_brazowa.y = 200
        spodnica_czerwona.x = 1500
        spodnica_czerwona.y = 200
    ...
    if mouseX >= width//2-550 and mouseX <= width//2-550 + 90 and mouseY >= height//2-60 - 30 and mouseY <= height//2-60 + 3:
        ...
        koszulka_czarna.x = 1500
        koszulka_czarna.y = 200
        spodnica_brazowa.x = 320
        spodnica_brazowa.y = 75
        spodnica_czerwona.x = 465
        spodnica_czerwona.y = 75
        spodnica_fioletowa.x = 615
        spodnica_fioletowa.y = 75
        spodnica_niebieska.x = 320
        spodnica_niebieska.y = 210
        spodnica_zielona.x = 465
        spodnica_zielona.y = 210
    if mouseX >= width//2-550 and mouseX <= width//2-550 + 175 and mouseY >= height//2+10 - 30 and mouseY <= height//2+10 + 3:
        ...
        spodnica_zielona.x = 1500
        spodnica_zielona.y = 200
    if mouseX <= width//2-550 + 150 and mouseY >= height//2+80 - 30 and mouseY <= height//2+80 + 3:
        hair_selected = False
        torso_selected = False
        legs_selected = False
        footwear_selected = False
        ...
        spodnica_zielona.x = 1500
        spodnica_zielona.y = 200
    if mouseX >= width//2-550 and mouseX <= width//2-550 + 200 and mouseY >= height//2+240 - 30 and mouseY <= height//2+240 + 3:
        hair_selected = False
        torso_selected = False
        legs_selected = False
        footwear_selected = False
        dresses_selected = False
        screebshot_selected = True
        #print("screenshot taken")
        minut = minute()# Values from 0 - 59 m
        h = hour()# Values from 0 - 23 h 
        d = day()  # Values from 1 - 31 d
        m = month()  # Values from 1 - 12 m
        y = year()  # 2023, 2022, 2021, etc.
        print("screenshot taken", "min", minut,"h.", h, "day", d, "month", m, "years", y)
        line(80, 20, 20, 80)
        save("uberanki.png")
        
    if mouseX >= 395 and mouseX <= 395+207 and mouseY >= 75 and mouseY <= 75 + 110 and hair_selected is True:
        hair_1.x = 795
    if mouseX >= 350 and mouseX <= 350+252 and mouseY >= 75 and mouseY <= 75 + 110 and hair_selected is False and torso_selected is True:
        bluzka_niebieska.x = 795
    if mouseX >= 475 and mouseX <= 475+127 and mouseY >= 75 and mouseY <= 75 + 110 and hair_selected is False and torso_selected is True:
        bluzka_rozowa.x = 795
...
def text_color():
    global fill_1, fill_2, fill_3, fill_4, fill_5, fill_6, hair_selected, torso_selected, legs_selected, footwear_selected, dresses_selected, screebshot_selected
    if hair_selected is True:
        ...
        fill_5 = 150
        fill_6 = 255
    elif screebshot_selected is True:
        fill_1 = 255
        fill_2 = 255
        fill_3 = 255
        fill_4 = 255
